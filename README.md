...
<head>
  ...
  <title>Happy Birthday Pearl</title>
  <style>
    :root{--bg1:#8A2BE2;--bg2:#B388FF;--text:#ffffff}
    ...
    pre.ascii{animation:floaty 4s ease-in-out infinite}
...
<body>
  <div class="card" role="main">
    <pre class="ascii" aria-hidden="false">        _ _
...
<div class="greeting">Happy Birthday Pearl!</div>
  </div>
